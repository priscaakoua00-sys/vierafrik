...
Réponds en 2-3 phrases max. Français uniquement. Emojis africains. Sois direct et actionnable.`;
        ...
        <div style={{display:"flex",flexDirection:"column",gap:10}}>
          ...
          <div style={{background:T.c1,border:`1px solid ${T.border}`,borderRadius:16,padding:"1.2rem"}}>
            ...
            <Btn full v="wa" ch="📱 Partager sur WhatsApp" onClick={()=>{
              const m=encodeURIComponent("Je gere mon business avec *VierAfrik* \uD83C\uDF0D\n\n- Dashboard en temps reel ✅\n- Factures PDF ✅\n- Mobile Money integre ✅\n- Coach IA personnel ✅\n\nEssaie gratuitement !\n\nhttps://vierafrik.com");
  ...
  const NAV_BOTTOM=[{id:"dash",ic:"📊",lb:"Accueil"},{id:"tx",ic:"💸",lb:"Ventes"},{id:"inv",ic:"🧾",lb:"Factures"},{id:"cli",ic:"👥",lb:"Clients"},{id:"pay_mm",ic:"📱",lb:"Mobile Money"},{id:"plans",ic:"💎",lb:"Plans"},{id:"coach",ic:"🤖",lb:"Coach"},{id:"prefs",ic:"⚙️",lb:"Compte"}];
  ...
  const PgAmbassadeur=()=>{
    ...
    const shareWA=()=>{
      const msg="Bonjour !\n\nJe te recommande VierAfrik, l'app pour gerer ton business en Afrique.\n\nDashboard, Factures, Mobile Money, Coach IA — tout en un !\n\nInscris-toi gratuitement ici :\n"+refLink+"\n\nVierAfrik — Gere tout.";
