...
Réponds en 2-3 phrases max. Français uniquement. Emojis africains. Sois direct et actionnable.`;
  ...
  const NAV_BOTTOM=[{id:"dash",ic:"📊",lb:"Accueil"},{id:"tx",ic:"💸",lb:"Ventes"},{id:"inv",ic:"🧾",lb:"Factures"},{id:"cli",ic:"👥",lb:"Clients"},{id:"pay_mm",ic:"📱",lb:"Mobile Money"},{id:"plans",ic:"💎",lb:"Plans"},{id:"ambass",ic:"🤝",lb:"Ambass."},{id:"coach",ic:"🤖",lb:"Coach"},{id:"prefs",ic:"⚙️",lb:"Compte"}];
  const NAV=[{id:"dash",ic:"📊",lb:"Dashboard"},{id:"tx",ic:"💸",lb:"Transactions"},{id:"inv",ic:"🧾",lb:"Factures"},{id:"cli",ic:"👥",lb:"Clients"},{id:"stats",ic:"📈",lb:"Stats"},{id:"coach",ic:"🤖",lb:"Coach IA"},{id:"plans",ic:"💎",lb:"Plans"},{id:"ambass",ic:"🤝",lb:"Ambassadeur"},{id:"avis",ic:"⭐",lb:"Avis"},{id:"carte",ic:"🪪",lb:"Carte Visite"},{id:"logo",ic:"🎨",lb:"Mon Logo"},{id:"reseau",ic:"🤝",lb:"Réseau"},{id:"proches",ic:"🗺️",lb:"Proches"},{id:"prefs",ic:"⚙️",lb:"Compte"}];
...
function CarteVisite({ user, accent = "#00d478", toast }) {
  ...
  const [activite, setActivite] = useState(user?.business || "");
  ...
  const shareWhatsApp = () => {
    const txt =
      `🏢 *${user?.business || user?.name || "Mon Commerce"}*\n` +
      `💼 ${activite || "Commerce & Services"}\n` +
      (ville ? `📍 ${ville}\n` : "") +
      (user?.phone ? `📱 ${user.phone}\n` : "") +
      (slogan ? `✨ "${slogan}"\n` : "") +
      `\n_Propulsé par VierAfrik 🌍 — vierafrik.com_`;
    window.open("https://wa.me/?text=" + encodeURIComponent(txt), "_blank");
    toast?.("📱 Partagé sur WhatsApp !", "ok");
  };

  // ── Copier texte ──
  const copyText = () => {
    const txt =
      `${user?.business || user?.name} | ${activite} | ${ville} | ${user?.phone || ""}`;
    try {
      ...
      toast?.("⚠️ Copie manuelle : appuyez longuement sur le texte", "warn");
    }
  };
  ...
  return (
    <div style={{ fontFamily: "'Inter','Segoe UI',system-ui,sans-serif", color: T.text }}>
      ...
      <div style={{ color:T.sub2, fontSize:12, marginBottom:20 }}>
        Votre carte professionnelle à partager sur WhatsApp et Facebook
      </div>

      {/* ── APERÇU CARTE ── */}
      <div style={{
        background: `linear-gradient(135deg,${couleur}22,${T.c1})`,
        ...
        position: "relative",
        overflow: "hidden",
        boxShadow: `0 20px 60px ${couleur}22`,
      }}>
        {/* Décorations */}
        <div style={{ position:"absolute",top:-30,right:-30,width:120,height:120,
          borderRadius:"50%",background:`${couleur}15`,pointerEvents:"none" }}/>
        <div style={{ position:"absolute",bottom:-20,left:-20,width:80,height:80,
          borderRadius:"50%",background:`${couleur}10`,pointerEvents:"none" }}/>
        ...
        <div style={{ display:"flex",alignItems:"center",gap:16,marginBottom:16,position:"relative" }}>
          <div style={{
            ...
            boxShadow: `0 8px 24px ${couleur}44`,
          }}>
            {initials}
          </div>
          <div>
            <div style={{ fontWeight:900, fontSize:18, color:T.text, letterSpacing:"-.02em" }}>
              {user?.business || user?.name || "Mon Commerce"}
            </div>
            {slogan && (
              <div style={{ fontSize:11, color:couleur, fontWeight:600, fontStyle:"italic", marginTop:2 }}>
                "{slogan}"
              </div>
            )}
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, position:"relative" }}>
          {user?.phone && (
            <div style={{ background:`${couleur}12`,borderRadius:10,padding:"8px 12px",
              display:"flex",alignItems:"center",gap:7 }}>
              <span style={{ fontSize:16 }}>📱</span>
              <div>
                <div style={{ fontSize:9,color:T.sub,fontWeight:700,textTransform:"uppercase" }}>Téléphone</div>
                <div style={{ fontSize:12,fontWeight:700,color:T.text }}>{user.phone}</div>
              </div>
            </div>
          )}
          {ville && (
            <div style={{ background:`${couleur}12`,borderRadius:10,padding:"8px 12px",
              ...
              <span style={{ fontSize:16 }}>📍</span>
              <div>
                <div style={{ fontSize:9,color:T.sub,fontWeight:700,textTransform:"uppercase" }}>Ville</div>
                <div style={{ fontSize:12,fontWeight:700,color:T.text }}>{ville}</div>
              </div>
            </div>
          )}
        </div>
        ...
        {/* Pied */}
        <div style={{ marginTop:12,paddingTop:12,borderTop:`1px solid ${couleur}22`,
          display:"flex",alignItems:"center",justifyContent:"space-between",position:"relative" }}>
          <div style={{ fontSize:9,color:T.sub }}>🌍 Propulsé par VierAfrik</div>
          <div style={{ background:couleur,borderRadius:20,padding:"2px 10px",
            fontSize:9,fontWeight:800,color:"#fff" }}>{planLabel}</div>
        </div>
      </div>
      ...
      <div style={{ background:T.c1,border:`1px solid ${T.border}`,borderRadius:16,
        ...
        <div style={{ fontWeight:800,fontSize:13,marginBottom:14 }}>🎨 Personnaliser</div>

        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10 }}>
          <div>
            <label style={{ fontSize:10,fontWeight:700,textTransform:"uppercase",
              letterSpacing:".07em",color:T.sub,display:"block",marginBottom:2 }}>Activité</label>
            <input style={IS} placeholder="Couture, Épicerie..."
              value={activite} onChange={ev => setActivite(ev.target.value)}/>
          </div>
          <div>
            <label style={{ fontSize:10,fontWeight:700,textTransform:"uppercase",
              letterSpacing:".07em",color:T.sub,display:"block",marginBottom:2 }}>Ville</label>
            <input style={IS} placeholder="Abidjan, Bouaké..."
              value={ville} onChange={ev => setVille(ev.target.value)}/>
          </div>
        </div>

        <div style={{ marginBottom:14 }}>
          <label style={{ fontSize:10,fontWeight:700,textTransform:"uppercase",
            letterSpacing:".07em",color:T.sub,display:"block",marginBottom:2 }}>Slogan (optionnel)</label>
          <input style={IS} placeholder="La qualité avant tout..."
            value={slogan} onChange={ev => setSlogan(ev.target.value)}/>
        </div>

        <div>
          <label style={{ fontSize:10,fontWeight:700,textTransform:"uppercase",
            letterSpacing:".07em",color:T.sub,display:"block",marginBottom:8 }}>Couleur</label>
          <div style={{ display:"flex",gap:8,flexWrap:"wrap" }}>
            {COULEURS.map(c => (
              <div key={c} onClick={() => setCouleur(c)} style={{
                width:28, height:28, borderRadius:"50%", background:c, cursor:"pointer",
                border: couleur===c ? "3px solid #fff" : "3px solid transparent",
                boxShadow: couleur===c ? `0 0 0 2px ${c}` : "",
                transition:"all .15s",
              }}/>
            ))}
          </div>
      ...
      <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10 }}>
        <button onClick={shareWhatsApp} style={{
          ...
          fontWeight:700,fontSize:13,background:"#25D366",color:"#fff",
          fontFamily:"inherit",
        ...
        <button onClick={copyText} style={{
          ...
          fontFamily:"inherit",
        }}>{copied ? "✅ Copié !" : "📋 Copier texte"}</button>
      </div>
    </div>
  );
}
...
function CommerçantsProches({
  ...
  const loadCommerçants = async () => {
    if (!supabase) return;
    try {
      const s = await supabase();
      const { data } = await s
        .from("commercants_profils")
        .select("*")
        .eq("visible", true)
        .order("created_at", { ascending: false })
        .limit(100);
      setCommerçants(data || []);
      // Trouver son propre profil
      const moi = (data || []).find(c => c.id === user?.id);
      if (moi) {
        setMonProfil(moi);
        setForm({ activite: moi.activite||"", ville: moi.ville||"", visible: moi.visible!==false });
      }
    } catch (e) {
      console.error("CommerçantsProches load error:", e);
    } finally {
      setLoading(false);
    }
  };

  useEffect(() => { loadCommerçants(); }, []);

  // ── Sauvegarder / mettre à jour son profil ──
  const saveProfile = async () => {
    ...
    try {
      ...
      if (monProfil) {
        await s.from("commercants_profils").update(data).eq("id", user?.id);
      } else {
        await s.from("commercants_profils").insert(data);
      }
      setMonProfil(data);
      setEditMode(false);
      await loadCommerçants();
      toast?.("✅ Profil mis à jour — visible par les autres commerçants !", "ok");
    } catch (e) {
  ...
  const liste = commercants.filter(c => {
    if (c.id === user?.id) return false; // exclure soi-même
    const matchFiltre = filtre === "Toutes" || c.activite?.toLowerCase().includes(filtre.toLowerCase());
    const matchRecherche = !recherche ||
      c.nom?.toLowerCase().includes(recherche.toLowerCase()) ||
      c.business?.toLowerCase().includes(recherche.toLowerCase()) ||
      c.activite?.toLowerCase().includes(recherche.toLowerCase()) ||
      c.ville?.toLowerCase().includes(recherche.toLowerCase());
    return matchFiltre && matchRecherche;
  });

  const flag = (pays) => PAYS_FLAGS[pays] || "🌍";
  ...
  const contacter = (c) => {
    const txt = `Bonjour ${c.nom || c.business}, je vous ai trouvé sur VierAfrik. Je voudrais vous contacter pour ${c.activite || "votre activité"}.`;
    toast?.("💡 Échangez votre numéro avec ce commerçant dans le Réseau VierAfrik !", "info");
  };
  ...
  return (
    <div style={{ fontFamily:"'Inter','Segoe UI',system-ui,sans-serif", color:T.text }}>
      ...
      {/* Titre */}
      <div style={{ fontWeight:900,fontSize:22,marginBottom:4,letterSpacing:"-.03em" }}>
        🗺️ Commerçants VierAfrik
      </div>
      <div style={{ color:T.sub2,fontSize:12,marginBottom:18 }}>
        Découvrez d'autres commerçants — recommandez-vous des clients, collaborez
      </div>

      {/* ── MON PROFIL ── */}
      <div style={{ background:`linear-gradient(135deg,${accent}15,${T.c1})`,
        border:`1px solid ${accent}44`,borderRadius:16,padding:"1.2rem",marginBottom:16 }}>
        <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",
          marginBottom: editMode ? 12 : 0 }}>
          <div style={{ fontWeight:800,fontSize:13 }}>
            {monProfil ? "✅ Votre profil est visible" : "👤 Rejoindre le réseau"}
          </div>
          <button onClick={() => setEditMode(e => !e)} style={{
            background: editMode ? `${accent}20` : T.c2,
            border:`1px solid ${accent}44`,borderRadius:8,cursor:"pointer",
            color:accent,fontSize:11,fontWeight:700,padding:"5px 12px",
            fontFamily:"inherit",
          }}>
        ...
        {!editMode && monProfil && (
          <div style={{ fontSize:12,color:T.sub2,marginTop:6 }}>
            {user?.business || user?.name} • {monProfil.activite} • {monProfil.ville || "Côte d'Ivoire"}
          </div>
        )}
        ...
        {editMode && (
          <div>
            <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10 }}>
              <div>
                <label style={{ fontSize:10,fontWeight:700,textTransform:"uppercase",
                  color:T.sub,display:"block",marginBottom:2 }}>Votre activité *</label>
                <input style={IS} placeholder="Couture, Épicerie, Téléphonie…"
                  value={form.activite}
                  onChange={ev => setForm(f => ({...f, activite: ev.target.value}))}/>
              </div>
              <div>
                <label style={{ fontSize:10,fontWeight:700,textTransform:"uppercase",
                  color:T.sub,display:"block",marginBottom:2 }}>Votre ville</label>
                <input style={IS} placeholder="Abidjan, Bouaké…"
                  value={form.ville}
                  onChange={ev => setForm(f => ({...f, ville: ev.target.value}))}/>
              </div>
            </div>
            <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:12 }}>
              <div onClick={() => setForm(f => ({...f, visible: !f.visible}))} style={{
                width:36,height:20,borderRadius:10,cursor:"pointer",
                background: form.visible ? accent : T.c3,
                border:`1px solid ${form.visible ? accent : T.border}`,
                position:"relative",transition:"all .2s",
              }}>
                <div style={{
                  width:16,height:16,borderRadius:"50%",background:"#fff",
                  position:"absolute",top:1,
                  left: form.visible ? 18 : 2,
                  transition:"left .2s",
                }}/>
              </div>
              <span style={{ fontSize:12,color:T.sub2 }}>
                {form.visible ? "Visible par les autres commerçants" : "Masqué du réseau"}
              </span>
            </div>
            <button onClick={saveProfile} disabled={saving} style={{
              width:"100%",padding:"10px",borderRadius:9,border:"none",
              background:accent,color:T.ink,fontWeight:700,fontSize:13,
              cursor:"pointer",fontFamily:"inherit",opacity:saving?0.6:1,
            }}>
              {saving ? "⏳ Sauvegarde…" : monProfil ? "💾 Mettre à jour" : "✅ Rejoindre le réseau"}
            </button>
          </div>
        )}
      </div>
      ...
      {/* ── RECHERCHE ── */}
      <input style={{ ...IS, marginBottom:10 }}
        placeholder="🔍 Rechercher un commerce, une activité, une ville…"
        value={recherche}
      ...
      <div style={{ display:"flex",gap:6,flexWrap:"wrap",marginBottom:14 }}>
        {ACTIVITES.map(a => (
          <div key={a} onClick={() => setFiltre(a)} style={{
            background: filtre===a ? `${accent}20` : T.c2,
            border:`1px solid ${filtre===a ? accent : T.border}`,
            borderRadius:20,padding:"4px 10px",cursor:"pointer",
            fontSize:11,fontWeight:700,
            color:filtre===a ? accent : T.sub2,
            transition:"all .15s",
          }}>
            {a}
          </div>
      ...
      {/* ── LISTE COMMERÇANTS ── */}
      {loading ? (
        <div style={{ textAlign:"center",padding:"3rem",color:T.sub,fontSize:12 }}>
          ⏳ Chargement…
        </div>
      ) : liste.length === 0 ? (
        <div style={{ background:T.c1,border:`1px solid ${T.border}`,borderRadius:16,
          ...
          <div style={{ fontWeight:700,fontSize:13,marginBottom:4,color:T.text }}>
            {commercants.length <= 1
              ? "Soyez le premier à rejoindre le réseau !"
              : "Aucun commerçant trouvé pour ce filtre"}
          </div>
          <div style={{ fontSize:11,color:T.sub2 }}>
            Rejoignez le réseau pour apparaître dans cette liste.
          </div>
        </div>
      ) : (
        <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
          <div style={{ fontSize:11,color:T.sub,marginBottom:4 }}>
            {liste.length} commerçant{liste.length > 1 ? "s" : ""} trouvé{liste.length > 1 ? "s" : ""}
          </div>
          {liste.map((c, i) => (
            <div key={c.id || i} style={{
              background:T.c1,border:`1px solid ${T.border}`,
              ...
              <div style={{
                ...
                background:`linear-gradient(135deg,${accent},${T.teal})`,
                display:"flex",alignItems:"center",justifyContent:"center",
                fontWeight:900,fontSize:16,color:T.ink,
              }}>
                {initials(c.business || c.nom)}
              </div>
              ...
              <div style={{ flex:1,minWidth:0 }}>
                ...
                <div style={{ fontSize:11,color:T.sub2,marginTop:2,
                  ...
                  <span>{flag(c.pays)} {c.pays || "CI"}</span>
                </div>
              </div>

              {/* Action */}
              <button onClick={() => contacter(c)} style={{
  ...
  const PgCommProches = () => <CommerçantsProches user={ses} supabase={getSupa} accent={accent} toast={toast}/>;

  const PMAP={dash:<PgDash/>,tx:<PgTx/>,inv:<PgInv/>,cli:<PgCli/>,stats:<PgStats/>,coach:<PgCoach/>,plans:<PgPlans/>,prefs:<PgParams/>,ambass:<PgAmbassadeur/>,avis:<PgAvis/>,carte:<PgCarteVisite/>,logo:<PgLogo/>,reseau:<PgReseau/>,proches:<PgCommProches/>};
