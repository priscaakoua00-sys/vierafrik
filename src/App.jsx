    ...
    if(screen===3&&mode==="propose"){
      ...
      return(
        <div style={{maxWidth:480,margin:"0 auto",animation:"slideUp .3s ease both"}}>
          ...
          {/* Images professionnelles automatiques — EN DEHORS du label */}
          {!propPreview && catObj && (
            <div style={{marginBottom:13}} onClick={e=>e.stopPropagation()}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:6}}>
                {[
                  ...
                  }} style={{cursor:"pointer",borderRadius:10,overflow:"hidden",border:`2px solid transparent`,transition:"all .2s"}}
