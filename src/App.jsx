    ...
    if(screen===3&&mode==="propose"){
      ...
      return(
        <div style={{maxWidth:480,margin:"0 auto",animation:"slideUp .3s ease both"}}>
          ...
          {!propPreview && catObj && (
            <div style={{marginBottom:13}}>
              <div style={{fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:".07em",color:T.sub,marginBottom:6}}>🖼️ Exemples d'images</div>
              <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:6}}>
                {[
                  ...
                  <div key={i} style={{borderRadius:10,overflow:"hidden",pointerEvents:"none"}}>
                    <img src={img} alt=""
