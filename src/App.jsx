...
// ⚠️ REMPLACER par la vraie anon key (eyJ...) depuis Supabase Dashboard → Settings → API
// La clé ci-dessous est une publishable key qui ne permet PAS les INSERT/UPDATE
const SUPA_KEY_DEFAULT = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9leHpwZnlnZXVuZWhrY3BvdWt2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI3MjEyNjcsImV4cCI6MjA4ODI5NzI2N30.qaq1iFyXZzqVF9phepNv4sKG4a_MdR0UFtXhH2N-oFQ";
// Utilise la clé testée via le panel diagnostic si disponible, sinon la clé par défaut
