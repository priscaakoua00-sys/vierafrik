        ...
        <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8,marginBottom:16 }}>
          {STYLES.map((s, i) => (
            <div key={i} onClick={() => { setStyleIdx(i); setSaved(false); }} style={{
              ...
              <div style={{ fontSize:10,fontWeight:700,color:styleIdx===i ? couleur1 : T.sub2 }}>
                {s.label}
              </div>
            </div>
          ))}
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:14 }}>
          <div>
            ...
            <div style={{ display:"flex",gap:6,flexWrap:"wrap" }}>
              {COULEURS_1.map(c => (
                <div key={c} onClick={() => { setCouleur1(c); setSaved(false); }} style={{
          ...
          <div>
            ...
            <div style={{ display:"flex",gap:6,flexWrap:"wrap" }}>
              {COULEURS_2.map(c => (
                <div key={c} onClick={() => { setCouleur2(c); setSaved(false); }} style={{
                  width:32,height:32,borderRadius:"50%",background:c,cursor:"pointer",
        ...
        <div>
          ...
          <div style={{ display:"flex",gap:8 }}>
            {[["rond","⭕ Rond"],["carre","🔲 Carré"],["libre","🔷 Libre"]].map(([f, label]) => (
              <div key={f} onClick={() => { setForme(f); setSaved(false); }} style={{
                flex:1, background:forme===f?`${couleur1}20`:T.c2,
                border:`2px solid ${forme===f?couleur1:T.border}`,
                borderRadius:8, padding:"12px 6px", textAlign:"center",
                cursor:"pointer", fontSize:12, fontWeight:700,
                color:forme===f?couleur1:T.sub2, transition:"border .1s,background .1s",
                minHeight:44, display:"flex", alignItems:"center", justifyContent:"center",
              }}>
                {label}
              </div>
