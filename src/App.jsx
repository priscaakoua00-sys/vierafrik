...
Réponds en 2-3 phrases max. Français uniquement. Emojis africains. Sois direct et actionnable.`;
  ...
  const PgParams=()=>{
    // ── State LOCAL à PgParams — jamais dans Dashboard pour éviter re-render ──
    ...
    if(screen===3&&mode==="propose"){
      ...
      return(
        <div style={{maxWidth:480,margin:"0 auto",animation:"slideUp .3s ease both"}}>
          ...
          {/* ── INPUT FILE isolé — déclenché UNIQUEMENT par le bouton photo ── */}
          <input id="photo-upload" type="file" accept="image/*" onChange={handleImage}
          ...
          <div style={{marginBottom:13}}>
            ...
            {propPreview ? (
              ...
              <button type="button"
                onClick={(e)=>{e.stopPropagation();e.preventDefault();document.getElementById("photo-upload").click();}}
          ...
          {/* ── IMAGES PRO — sélection directe, AUCUN lien avec input file ── */}
          {!propPreview && catObj && (
            <div style={{marginBottom:13}}>
