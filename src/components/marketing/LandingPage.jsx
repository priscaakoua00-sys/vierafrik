      ...
      <footer>
        <div className="wrap">
          <div className="foot-grid">
            ...
            <div className="foot-col"><h4>Ressources</h4><a href="#ebook">eBook gratuit</a><a href="#fondatrice">À propos</a><a href="/privacy-policy.html">Confidentialité</a><a href="/conditions-generales.html">CGU</a><a href="/mentions-legales.html">Mentions légales</a></div>
